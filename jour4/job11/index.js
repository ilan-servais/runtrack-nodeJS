...
// Fonction pour exporter les données des étudiants dans un fichier JSON
const exportStudentsToJSON = () => {
  // Récupérer les données de la collection Student
  Student.find()
    .populate('year_id') // Peupler les références
    .then(students => {
      // Écrire les données dans un fichier JSON
      const jsonData = JSON.stringify(students, null, 2); // Convertir les données en JSON avec une indentation de 2 espaces
